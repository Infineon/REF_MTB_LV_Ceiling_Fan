...
//#include "../MCUInit/DAVE.h"
#include "../MCUInit/ccu4.h"
#include "../MCUInit/clock.h"
#include "../MCUInit/gpio.h"
#include "../MCUInit/interrupt.h"
#include "../MCUInit/timer.h"
...
extern bool  IRrecv_decodeNEC (ir_decode_results *results);
...
#if IR_DECODE_NEC
	IR_DBG_PRINTLN("Attempting NEC decode")
	if (IRrecv_decodeNEC(results))  return 1 ;
#endif
...
//+=============================================================================
void IRrecv_IRrecvInit (const DIGITAL_IO_t* recvpin)
{
