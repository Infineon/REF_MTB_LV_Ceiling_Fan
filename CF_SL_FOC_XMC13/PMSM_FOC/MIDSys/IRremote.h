...
//
#define IR_DECODE_SONY          0
#define IR_SEND_SONY            0

#define IR_DECODE_NEC           1
#define IR_SEND_NEC             0

#define IR_DECODE_SAMSUNG       0
#define IR_SEND_SAMSUNG         0
...
#if IR_SEND_NEC
extern void IRsend_sendNEC (unsigned long data, int nbits);
#endif
